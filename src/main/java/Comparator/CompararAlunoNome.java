...
/**
 * Implementação de {@link Comparator} para comparar objetos {@link Aluno} com base no nome.
 * Esta classe permite ordenar ou comparar instâncias de {@link Aluno} pela propriedade de nome,
 * utilizando uma comparação alfabética personalizada.
 * 
 * @author laviniacharrua e iasmintorres
 */
public class CompararAlunoNome implements Comparator<Aluno> {

    /**
     * Compara dois objetos {@link Aluno} com base no nome.
     *
     * @param a1 o primeiro objeto {@link Aluno} para comparação
     * @param a2 o segundo objeto {@link Aluno} para comparação
     * @return um valor negativo, zero, ou positivo se o nome de {@code a1} for, respectivamente,
     *         menor, igual ou maior que o nome de {@code a2}
     */
    @Override
    public int compare(Aluno a1, Aluno a2) {
        return compareStrings(a1.getNome(), a2.getNome());
    }
